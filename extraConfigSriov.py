    ...
    if image is not None:
        ...
        container_infos = [
            GitBuildLocalContainerInfo(
                ...
                containerfile=("Dockerfile.ocp", "Dockerfile.rhel7"),
                registry=registry,
                project=project,
            ),
            GitBuildLocalContainerInfo(
                ...
                containerfile=("Dockerfile.sriov-network-config-daemon.ocp", "Dockerfile.sriov-network-config-daemon.rhel7"),
                registry=registry,
                project=project,
            ),
            GitBuildLocalContainerInfo(
                ...
                containerfile=("Dockerfile.webhook.ocp", "Dockerfile.webhook.rhel7"),
                registry=registry,
                project=project,
            ),
        ]
